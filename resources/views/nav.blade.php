        ...
        <div class="flex justify-between items-center p-4 md:justify-between md:px-8 md:p-0 md:py-4">
            ...
            <div id="menuBox"
                ...
                <div class="flex flex-col items-start gap-4 md:flex-row md:gap-0 md:justify-evenly md:w-[60%]">
                    ...
                    <a href="#home"
                        class="text-base text-white font-semibold md:text-main-100  hover:text-secondary-200 duration-200 dark:text-main-100 md:dark:text-white hover:dark:text-secondary-200">Home</a>
                    <a href="#movies"
                        class="text-base text-white font-semibold md:text-main-100 hover:text-secondary-200 duration-200 dark:text-main-100 md:dark:text-white hover:dark:text-secondary-200">Movies</a>
                    <a href="#booking"
                        class="text-base text-white font-semibold md:text-main-100 hover:text-secondary-200 duration-200 dark:text-main-100 md:dark:text-white hover:dark:text-secondary-200">Booking</a>
                    <a href="#about us"
                        class="text-base text-white font-semibold md:text-main-100 hover:text-secondary-200 duration-200 dark:text-main-100 md:dark:text-white hover:dark:text-secondary-200">About
                        Us</a>
                ...
                <div class="flex flex-col mt-2 md:mt-0 md:flex-row md:justify-evenly md:items-center md:gap-4">
                    ...
                    <div id="theme" class="light my-1 cursor-pointer md:my-0">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" id="light"
                            class="w-6 h-6 text-secondary-200 active:text-green-600">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            ...
                            class="w-6 h-6 hidden text-white dark:text-secondary-200">
                            <path stroke-linecap="round" stroke-linejoin="round"
